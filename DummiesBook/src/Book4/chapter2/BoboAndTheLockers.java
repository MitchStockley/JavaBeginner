...
public class BoboAndTheLockers {
    public static void main(String[] args) {
        ...
        {
            System.out.println("Bobo changing every: " + skip + " Lockers");

            for(int locker = skip; locker < 1000; locker += skip)
                lockers[locker] =  !lockers[locker];
        }

        System.out.println("Bobo is bored and is now going home..");
        ...
        System.out.println("Bobo has left " + openCount + " lockers open");
